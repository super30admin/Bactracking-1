//Time Complexity:O(N*2^N) where N is the size of the candidate array. N is the decision space and 2^N is exploring each decision space's different combinations. 
